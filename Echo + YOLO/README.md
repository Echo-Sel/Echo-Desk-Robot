...
1. **Install System Dependencies**  
   Run these commands to install required system libraries and camera tools:
   ```bash
   sudo apt-get update
   sudo apt-get install python3-venv portaudio19-dev libasound2-dev libcap-dev libespeak1 libcamera-dev libcamera-apps python3-opencv -y
   ```
...
3. **Set Up a Virtual Environment (Recommended for Pi)**  
